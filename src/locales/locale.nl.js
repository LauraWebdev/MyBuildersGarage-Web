const messages = {
    ...
    "register": {
        ...
        "form": {
            "usernamePlaceholder": "Gebruikersnaam",
            "usernameRequirements": "Toegestane tekens: a-z, A-Z, 0-9, koppeltekens, onderstrepingstekens",
            "passwordPlaceholder": "Wachtwoord",
            "passwordAgainPlaceholder": "Wachtwoord (Opnieuw)",
            "emailPlaceholder": "E-mail",
            "registerButton": "Registreren"
        },
        "snackbar": {
            "success": "Nieuw account is succesvol aangemaakt.",
            "error": {
    ...
    "index": {
        ...
        "support": "Hallo daar, als je mij wil steunen of ons wil helpen onze severs te financieren, overweeg het alstublieft om aan de PayPal geldpot te doneren, of koop een van onze games op itch.io! <i>&dash; Laura</i>",
    ...
    "channelOverview": {
        ...
        "explaination": "Ontdek nieuwe games met een specifiek onderwerp, stijl of concept."
    },
    "channelDetail": {
        "snackbar": {
    ...
    "gameAdd": {
        "header": "Voeg een nieuwe game toe",
        ...
        "action": {
            ...
            "goToGameButton": "Ga naar game pagina"
        },
        "snackbar": {
    ...
    "gameDelete": {
        ...
        "snackbar": {
            "success": "Game is verwijderd.",
            "error": "Kon de game niet verwijderen."
        }
    },
    "gameDetail": {
        "action": {
        ...
        "comments": {
            "form": {
                "notLoggedIn": "Log in om reacties te plaatsen<br />en feedback te geven!",
                "commentButton": "Reageer"
            },
            "noComments": "Deze game heeft nog geen reacties."
        },
        "trailerOverlay": {
            "closeButton": "Sluiten"
        },
        "snackbar": {
            "error": {
                "serverError": "Game kon niet geladen worden door een fout in de server. Probeer het later nog eens",
                "notFound": "We konden geen game vinden die overeenkomt met deze criteria.",
                "private": "Je mag deze game niet zien."
            },
            "comments": {
                "success": {
                ...
                "error": {
                    ...
                    "postedServerError": "Reactie kon niet geplaatst worden door een fout in de server. Probeer het later nog eens",
                    "deletedServerError": "Reactie kon niet verwijderd worden door een fout in de server. Probeer het later nog eens",
                    "notEmpty": "Reacties kunnen niet leeg zijn."
                }
            }
        }
    },
    "gameEdit": {
        ...
        "media": {
            "form": {
                "fileHint": ".png / .jpg",
                "deleteCoverButton": "Omslagfoto Verwijderen"
            }
        },
        "screenshots": {
            "header": "Screenshots"
        },
        "backToGamePageButton": "Terug naar de gamepagina",
        "saveButton": "Opslaan",
        "snackbar": {
            "success": {
                "screenshotDeleted": "Screenshot is verwijderd.",
                "coverUpdated": "Omslagfoto is bijgewerkt.",
                "coverDeleted": "Omslagfoto is verwijderd.",
                "screenshotUploaded": "Screenshots zijn succesvol geüpload.",
                "saved": "Veranderingen opgeslagen."
            },
            "error": {
                "loadServerError": "Game kon niet geladen worden door een fout in de server. Probeer het later nog eens",
                "loadNotFound": "We konden geen game vinden die overeenkomt met deze criteria.",
    ...
    "playlistDetail": {
        "header": "Afspeellijst",
        "nogames": "Er zijn nog geen games in deze afspeellijst.",
        "snackbar": {
            "error": {
                "notFound": "Afspeellijst kon niet geladen worden door een fout in de server. Probeer het later nog eens",
                "notAllowed": "Je mag deze afspeellijst niet zien."
            }
        }
    },
    "userDetail": {
        "meta": {
            ...
            "ingameID": "Ingame-ID",
            "joinedDate": "Account gemaakt op",
            "teamVerified": "Deze gebruiker is een geverifieerd lid van het MyGarage.games team."
        },
        "action": {
            "edit": "Bewerken",
    ...
    "userEdit": {
        ...
        "backToProfileButton": "Terug naar profiel",
        "saveButton": "Opslaan",
        "snackbar": {
            "success": {
                "avatarUpdated": "Profielfoto is bijgewerkt.",
                "avatarDeleted": "Profielfoto is verwijderd.",
                "saved": "Veranderingen opgeslagen."
            },
            "error": {
    ...
    "footer": {
        "disclaimer": "MyGarage.games is a gratis platform door de community en is op geen manier verwant met Nintendo.<br />Gamestudio is een trademark van Nintendo.",
        "legalLink": "Legale informatie",
        "apiLink": "API"
    }
}
